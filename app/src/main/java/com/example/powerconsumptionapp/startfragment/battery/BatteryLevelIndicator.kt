package com.example.powerconsumptionapp.startfragment.battery
...
class BatteryLevelIndicator @JvmOverloads constructor(
    ...
    /*
        Region inside the border -> battery percentage
    */
   ...
   */
    ...
    /*
        Draw path, battery level and border on canvas
     */
    override fun onDraw(canvas: Canvas) {
        Log.d("[IOANA]", "percentage: ${percentage}")
    ...
    /*
        Path and RectF will be combined together => drawn on Canvas
     */
    ...
    private fun drawPercentage(canvas: Canvas, percentage: Float) {
        ...
        // Calculate the right position to display the battery percentage
        percentRect.right =
    ...
    private fun readAttributes(typedValue: TypedArray) {
        ...
        Log.d("[IOANA]", "PERCENT IN readAttributes: ${percentage}")
        cornerRadius =
